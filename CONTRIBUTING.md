...
- Search for an existing report under [Issues](https://github.com/bubustack/github-webhook-impulse/issues).
- If nothing matches, [open a new issue](https://github.com/bubustack/github-webhook-impulse/issues/new) with a clear description, reproduction steps, and both observed and expected behaviour.
